...
public class ManagecontactTest extends Base {
	...
	public void verifyuserisableTomanageContactDetails() throws IOException {
		...
		manage = home.clickmanagecontact().manageeditclick().phonenumberfield("1234567890")
				.eneteremail("sapple123@gmail.com").addressfield("Obsqurazone kochi,infoparkroad,4tyy")
				.deliverytime("20").deliverlimit("1000").updateclick();
